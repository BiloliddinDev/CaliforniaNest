...
const VisionAndGoals = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-20 right-1/4 w-64 h-64 bg-custom-blue/10 rounded-full blur-3xl animate-pulse-glow" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {visionCards.map((card, index) => (
            isMobile ? (
              ...
              >
                <div className={`w-12 h-12 ${card.color} rounded-lg flex items-center justify-center text-white text-xl mb-4 animate-pulse-glow`}>
                  {card.icon}
                </div>
              ...
              >
                <div className={`w-14 h-14 ${card.color} rounded-lg flex items-center justify-center text-white text-2xl mb-4 animate-pulse-glow`}>
                  {card.icon}
                </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-10">
            <div className="w-full md:w-1/3 relative h-64 md:h-80">
              <div className="relative w-full h-full rounded-xl overflow-hidden shadow-md transform hover:scale-[1.02] transition-all duration-500">
