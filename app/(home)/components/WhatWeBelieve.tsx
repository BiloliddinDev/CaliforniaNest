...
const WhatWeBelieve = () => {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute bottom-20 right-1/4 w-80 h-80 bg-custom-dark/5 rounded-full blur-3xl animate-blob animation-delay-2000"/>
            <div
                className="absolute -bottom-10 left-1/4 w-64 h-64 bg-custom-blue/10 rounded-full blur-3xl animate-pulse-glow"/>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                >
                    ...
                    <p className="text-custom-dark/80 max-w-2xl mx-auto text-lg leading-relaxed">
                        We believe that exceptional personal branding is born from the perfect balance of authenticity
                        and strategy.
                        Our approach combines creative storytelling with data-driven insights to create digital
                        presences that
                        ...
                        isMobile ? (
                            ...
                            >
                                <div className="flex items-center mb-5">
                                    <div
                                        className={`w-12 h-12 bg-gradient-to-r ${card.color} rounded-lg flex items-center justify-center text-white text-xl animate-pulse-glow shadow-md`}>
                                        <span className={"text-primary"}> {card.icon}</span>
                                    </div>
                                    <div
                                        className="h-0.5 flex-grow ml-4 bg-gradient-to-r from-custom-blue/30 to-transparent rounded-full"></div>
                                </div>
                            ...
                            >
                                <div className="flex items-center mb-6">
                                    ...
                                    <div
                                        className="h-0.5 flex-grow ml-5 bg-gradient-to-r from-custom-blue/40 to-transparent rounded-full"></div>
                                </div>
