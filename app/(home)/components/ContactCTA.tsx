  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="bg-gradient-to-r from-custom-blue/10 to-custom-light/30 rounded-3xl p-12 md:p-16 shadow-xl border border-custom-light/30 overflow-hidden relative">
          {/* Background image */}
     
          
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 w-40 h-40 bg-custom-blue/10 rounded-full blur-2xl transform translate-x-1/2 -translate-y-1/2" />
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-custom-blue/10 rounded-full blur-2xl transform -translate-x-1/2 translate-y-1/2" />
